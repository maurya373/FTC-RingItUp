...
@synthesize peg1, peg2, peg3, peg4, peg5, peg6, peg7, peg8, peg9;
...
@synthesize Rscore, Bscore, RedOnMat, BlueOnMat, redringsleft, blueringsleft;
...
- (int) placeRingOnPeg:(UIImageView *)peg:(int)pegValue:(UIImageView *)pegPlacementArea:(int)points {
    ...
    UIImage *rf     = [UIImage imageNamed: @"rf.png"];
    UIImage *rrf    = [UIImage imageNamed: @"rrf.png"];
    UIImage *rrrf   = [UIImage imageNamed: @"rrrf.png"];
    UIImage *bf     = [UIImage imageNamed: @"bf.png"];
    UIImage *bbf    = [UIImage imageNamed: @"bbf.png"];
    UIImage *bbbf   = [UIImage imageNamed: @"bbbf.png"];
    UIImage *rbf    = [UIImage imageNamed: @"rbf.png"];
    UIImage *brf    = [UIImage imageNamed: @"brf.png"];
    UIImage *rbrf   = [UIImage imageNamed: @"rbrf.png"];
    UIImage *rrbf   = [UIImage imageNamed: @"rrbf.png"];
    UIImage *brbf   = [UIImage imageNamed: @"brbf.png"];
    UIImage *brrf   = [UIImage imageNamed: @"brrf.png"];
    UIImage *bbrf   = [UIImage imageNamed: @"bbrf.png"];
    UIImage *rbbf   = [UIImage imageNamed: @"rbbf.png"];
    UIImage *rrrrf  = [UIImage imageNamed: @"rrrrf.png"];
    UIImage *rrrbf  = [UIImage imageNamed: @"rrrbf.png"];
    UIImage *rrbrf  = [UIImage imageNamed: @"rrbrf.png"];
    UIImage *rrbbf  = [UIImage imageNamed: @"rrbbf.png"];
    UIImage *rbrrf  = [UIImage imageNamed: @"rbrrf.png"];
    UIImage *rbrbf  = [UIImage imageNamed: @"rbrbf.png"];
    UIImage *rbbrf  = [UIImage imageNamed: @"rbbrf.png"];
    UIImage *rbbbf  = [UIImage imageNamed: @"rbbbf.png"];
    UIImage *bbbbf  = [UIImage imageNamed: @"bbbbf.png"];
    UIImage *bbbrf  = [UIImage imageNamed: @"bbbrf.png"];
    UIImage *bbrbf  = [UIImage imageNamed: @"bbrbf.png"];
    UIImage *bbrrf  = [UIImage imageNamed: @"bbrrf.png"];
    UIImage *brbbf  = [UIImage imageNamed: @"brbbf.png"];
    UIImage *brbrf  = [UIImage imageNamed: @"brbrf.png"];
    UIImage *brrbf  = [UIImage imageNamed: @"brrbf.png"];
    UIImage *brrrf  = [UIImage imageNamed: @"brrrf.png"];
...
- (IBAction)clearRack:(id)sender {
    ...
    app.numOfBlueOnMat1 = 0;
    app.numOfRedOnMat1 = 0;
    ...
    UIImage *image = [UIImage imageNamed: @"emptyf.png"];
